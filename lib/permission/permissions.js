...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.BYPASS_VPN_BLOCK]: { label: 'Bypass VPN Block', desc: 'Bypass VPN/proxy blocking.' },
	...
	[Permissions.USE_MARKDOWN_POLL]: { label: 'Polls', desc: 'Create polls in posts' },
