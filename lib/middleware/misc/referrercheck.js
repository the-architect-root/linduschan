...
module.exports = (req, res, next) => {
	...
	// Skip referrer check for login, register, change password, captcha, and bypass
	const skipPaths = ['/forms/login', '/forms/register', '/forms/changepassword', '/forms/newcaptcha', '/forms/blockbypass'];
